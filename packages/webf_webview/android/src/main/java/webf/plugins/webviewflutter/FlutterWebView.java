...
package webf.plugins.webviewflutter;
...
public class FlutterWebView implements PlatformView, MethodCallHandler {
  ...
  FlutterWebView(
    ...
    methodChannel = new MethodChannel(messenger, "plugins.webf/webview_" + id);
  ...
  private void setupJavascriptBridge(Result result) {
    webView.addJavascriptInterface(this, "webf");
    result.success(null);
  }

  private void teardownJavascriptBridge(Result result) {
    webView.removeJavascriptInterface("webf");
    result.success(null);
  }
