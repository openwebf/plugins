...
abstract class WebViewElement extends Element {
  ...
  void setAttribute(String key, String value) {
    ...
    switch (key) {
      case SRC:
        ...
        break;
      case WIDTH:
        width = attributeToProperty<double>(value);
        break;
      case HEIGHT:
        height = attributeToProperty<double>(value);
        break;
    }
  }
  ...
  void setBindingProperty(String propertyName, value) {
    switch (propertyName) {
      case SRC:
        ...
        break;
      case WIDTH:
        width = castToType<num>(value).toDouble();
        break;
      case HEIGHT:
        height = castToType<num>(value).toDouble();
        break;
      default:
        super.setBindingProperty(propertyName, value);
    }
  }
  ...
  /// Default userAgent for webf.
  static const String DEFAULT_USER_AGENT =
      'Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko) Chrome Mobile Safari/537.36 AliApp(WebF/0.3.0)';
...
class IFrameElement extends WebViewElement {
  ...
  invokeBindingMethod(String method, List args) {
    switch (method) {
      case 'onPostMessage':
        return onPostMessage(castToType<String>(args[0]));
      default:
