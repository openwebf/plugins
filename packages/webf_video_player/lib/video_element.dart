  ...
  void setAttribute(String key, String value) {
    ...
    switch (key) {
      case 'src':
        ...
        break;
      case 'loop':
        loop = attributeToProperty<bool>(value);
        break;
      case 'currentTime':
        currentTime = attributeToProperty<int>(value);
        break;
    }
  }
  ...
  void setBindingProperty(String key, value) {
    switch (key) {
      case 'src':
        ...
        break;
      case 'loop':
        loop = castToType<bool>(value);
        break;
      case 'autoplay':
        autoplay = castToType<bool>(value);
        break;
      case 'currentTime':
        currentTime = castToType<num>(value).toInt();
        break;
      default:
  ...
  getBindingProperty(String key) {
    switch (key) {
      case 'play':
        return _bindingPlay;
      case 'pause':
        return _bindingPause;
      case 'fastSeek':
        return _bindingFastSeek;
      case 'autoplay':
        return autoplay;
      case 'loop':
        return loop;
